...
import (
	...
	"github.com/GavukaAlexandr/ent-sandbox/ent/predicate"
...
func (pu *PetUpdate) SetSkills(s []string) *PetUpdate {
	pu.mutation.SetSkills(s)
	return pu
}

// ClearSkills clears the value of the "skills" field.
func (pu *PetUpdate) ClearSkills() *PetUpdate {
...
// SetSkills sets the "skills" field.
func (puo *PetUpdateOne) SetSkills(s []string) *PetUpdateOne {
	puo.mutation.SetSkills(s)
	return puo
}

// ClearSkills clears the value of the "skills" field.
func (puo *PetUpdateOne) ClearSkills() *PetUpdateOne {
